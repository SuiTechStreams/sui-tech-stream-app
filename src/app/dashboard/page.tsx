  ...
  return (
    <div className="w-full p-5">
      ...
      <Tabs value={activeTab}>
        <TabsList className="flex space-x-4 px-4 py-6 bg-customLightPurple-dark_foreground dark:bg-customPurple-foreground rounded-2xl">
          <TabsTrigger
            value="stream details"
            className="py-2 px-6 text-md border-b-2 border-transparent bg-customLightPurple dark:bg-black hover:border-gray-500 focus:outline-none focus-visible:border-blue-500 text-customLightPurple-dark_text dark:text-white"

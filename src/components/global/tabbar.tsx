  ...
  return (
    <div className="">
      <Tabs value={activeTab}>
        <TabsList className="flex space-x-4 border-b-2 bg-gray-800 border-gray-300 px-4">
          <TabsTrigger
            value="all"
            className="py-2 px-6 text-xl border-b-2 border-transparent hover:border-gray-500 focus:outline-none focus-visible:border-blue-500"
